...
public class LoginPage implements ActionListener {
    ...
    LoginPage(HashMap<String, String> loginInfoOriginal) {
        ...
        messagLabel.setBounds(125, 250, 450, 35);
        ...
        frame.setTitle("Login Page  hunabopa.com/loginpage");
        ...
        if (e.getSource() == loginButton) {
            ...
            if (logininfo.containsKey(userID)) {
                if (logininfo.get(userID).equals(password)) {
                    messagLabel.setForeground(Color.magenta);
                    messagLabel.setText("Login Successful");
                    frame.dispose();
                    WelcomePage welcomePage = new WelcomePage(userID);
                } else {
                    messagLabel.setForeground(Color.red);
                    messagLabel.setText("Login unsuccessful -> wrong password");
